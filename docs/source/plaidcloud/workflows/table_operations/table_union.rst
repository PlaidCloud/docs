...
Use to combine multiple data tables with the same column
structure into a single data table. For example, time series data is a
prime candidate for this transform. The result is always the distinct set of records after combining the data.

.. note:: **Union** removes duplicates. If you want to keep all records
...
.. image:: ../../../_static/images/transforms/table_union.png
   :alt: Table Append
...
.. |Table Append 1| image:: ../../../_static/images/transforms/table_union_1.png
.. |Table Append 2| image:: ../../../_static/images/transforms/table_union_2.png
.. |Table Append 3| image:: ../../../_static/images/transforms/table_union_3.png
