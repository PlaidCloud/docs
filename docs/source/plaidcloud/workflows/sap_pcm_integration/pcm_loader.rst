...
Loads an SAP Profitability and Cost Management (PCM) model using direct
...
.. image:: ../../../_static/images/transforms/PCM_hyper_loader.png
   :alt: PCM Hyper Loader

Examples
--------

.. image:: ../../../_static/images/transforms/PCM_hyper_loader_1_ex.png
   :alt: PCM Hyper Loader

Select Agent to Use from the dropdown. Enter model name and select the load package
storage path location, then select the child folder desired from within.
Use the Table Data Selection below to select the source table model and
the target load table. Inspect source>>propagate both sides of the table
