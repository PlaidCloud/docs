...
Sets project variables for use during the workflow. A variable name
...
The table will display the list of registered project variables and the
...
.. image:: ../../../_static/images/transforms/model_variable_unregistered.png
   :alt: Create Unregistered Project Variable

.. |Icon| image:: https://plaidcloud.com/client/resource/fugue/icons/tag-share.png
