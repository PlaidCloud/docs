...
autodoc_mock_imports = ["plaid", "plaidtools", "plaidcloud", "magic", "sqlalchemy", "toolz", "unicodecsv", "numpy", "psycopg2", "gevent", "faker", "sqlalchemy_views", "pika", "simplejson", "sqlalchemy_utils", "pandas"]
